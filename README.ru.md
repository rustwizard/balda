...
- **Быстрый бой** — основной режим. Одна кнопка «Играть»: очередь матчмейкинга подбирает соперника с близким ELO-рейтингом, игра начинается сразу.
...
| `lobby` | `match_found` | Быстрый бой нашёл игру |
...
Отправляется в канал `lobby`, когда матчмейкинг нашёл игру. Содержит снимок доски и персональный `game_token` каждого игрока, чтобы клиент вошёл в игру без гонки с событиями первого хода. Клиент фильтрует по своему `uid`.
