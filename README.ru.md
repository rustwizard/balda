...
- **Быстрый бой** — основной режим. Одна кнопка «Играть»: очередь матчмейкинга подбирает соперника с близким ELO-рейтингом; если подходящего нет — автоматически начинается игра с ботом.
...
| `lobby` | `match_found` | Быстрый бой нашёл игру (соперник-человек или фолбэк в бота) |
