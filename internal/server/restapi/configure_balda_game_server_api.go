...
//go:generate swagger generate server --target ../../../../balda --name BaldaGameServerAPI --spec ../../../api/swagger/http-api.yaml --server-package internal/server/restapi --principal interface{}

func configureFlags(api *operations.BaldaGameServerAPIAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.BaldaGameServerAPIAPI) http.Handler {
